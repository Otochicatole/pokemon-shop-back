...
export class ProductAdminRepositoryAdapter implements ProductAdminRepository {
  ...
  addProductImages(actor: AdminActor, productId: string, expectedVersion: number, files: readonly { id: string; altText?: string }[]) { return this.source.addProductImages(actor, productId, expectedVersion, files); }

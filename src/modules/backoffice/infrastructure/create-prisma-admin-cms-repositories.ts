...
import { ExchangeRateSettingsAdminRepositoryAdapter } from './repositories/exchange-rate-settings-admin-repository.js';
...
export function createPrismaAdminCmsRepositories(prisma: PrismaClient, coordinator: WriteCoordinator, realtime?: SupportRealtimeHub): AdminCmsRepositories {
  ...
  return {
    ...
    exchangeRateSettings: new ExchangeRateSettingsAdminRepositoryAdapter(store),
